structure(list(url = "sleeper/v1/league/386236959468675072", 
    status_code = 200L, headers = structure(list(date = "Sat, 12 Jun 2021 13:18:38 GMT", 
        `content-type` = "application/json; charset=utf-8", `transfer-encoding` = "chunked", 
        connection = "keep-alive", vary = "Accept-Encoding", 
        `cache-control` = "max-age=0, private, must-revalidate", 
        `x-request-id` = "5f274dfc7624c6d9f3f8acde0d239c21", 
        ...
        `cf-request-id` = "0aa1f8edc80000381895394000000001", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        server = "cloudflare", `cf-ray` = "65e35dc2d9f63818-IAD"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sat, 12 Jun 2021 13:18:38 GMT", 
    ...
    date = structure(1623503918, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 3e-05, 
    connect = 3.1e-05, pretransfer = 8.2e-05, starttransfer = 0.046205, 
    total = 0.046339)), class = "response")
