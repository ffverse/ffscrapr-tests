structure(list(url = "https://www61.myfantasyleague.com/2020/export?TYPE=rules&L=54040&JSON=1", 
    status_code = 200L, headers = structure(list(date = "Sat, 12 Jun 2021 14:35:40 GMT", 
        server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        `content-type` = "application/json; charset=utf-8", expires = "Fri, 12 Jun 2020 14:35:40 GMT", 
    ...
    "list")), all_headers = list(list(status = 302L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sat, 12 Jun 2021 14:35:40 GMT", 
            server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        ...
        headers = structure(list(date = "Sat, 12 Jun 2021 14:35:40 GMT", 
            ...
            expires = "Fri, 12 Jun 2020 14:35:40 GMT", `cache-control` = "private", 
    ...
    date = structure(1623508540, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.134797, namelookup = 4.5e-05, 
    connect = 4.9e-05, pretransfer = 0.000129, starttransfer = 0.291318, 
    total = 0.291462)), class = "response")
