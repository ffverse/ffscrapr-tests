structure(list(url = "mfl/2020/export?TYPE=leagueSearch&SEARCH=sfbx%20conference&JSON=1", 
    status_code = 200L, headers = structure(list(date = "Sat, 12 Jun 2021 14:05:08 GMT", 
        server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        `content-type` = "application/json; charset=utf-8", expires = "Fri, 12 Jun 2020 14:05:08 GMT", 
        `cache-control` = "private", `access-control-allow-origin` = "https://www70.myfantasyleague.com", 
        vary = "Accept-Encoding", `content-encoding` = "gzip", 
        `content-length` = "316", `set-cookie` = "utf-8", targethost = "www70"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sat, 12 Jun 2021 14:05:08 GMT", 
            server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
            `content-type` = "application/json; charset=utf-8", 
            expires = "Fri, 12 Jun 2020 14:05:08 GMT", `cache-control` = "private", 
            `access-control-allow-origin` = "https://www70.myfantasyleague.com", 
            vary = "Accept-Encoding", `content-encoding` = "gzip", 
            `content-length` = "316", `set-cookie` = "utf-8", 
    ...
    date = structure(1623506708, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.002072, 
    connect = 0.027591, pretransfer = 0.096925, starttransfer = 0.389222, 
    total = 0.391161)), class = "response")
